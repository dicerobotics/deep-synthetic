...
echo "Training CUT for mwir_real2cut### ..."
python train.py \
  --dataroot ./../../datasets/mwir_real2cut \
  --name mwir_real2cut \
  --CUT_mode CUT \
  --n_epochs 100 \
  --n_epochs_decay 100 \
...
echo "Finished training CUT for mwir_real2cut."


echo "Testing/infering CUT for mwir_real2cut..."
python test.py \
  --dataroot ./../../datasets/mwir_real2cut \
  --name mwir_real2cut \
  --CUT_mode CUT \
  ...
  --no_dropout \
  --results_dir ./../../results/ \
  --num_test 50  # Default 50, Or a large number greater than your dataset size i.e. 9200 for mwir_real2cut

echo "Finished testing/infering CUT for mwir_real2cut."
